...
namespace Exchange {
    ...
    struct EXTERNAL IStoreInspector : virtual public Core::IUnknown {
        ...
        virtual uint32_t SetNamespaceLimit(const string& ns, const uint32_t size, const ScopeType scope) = 0;
        virtual uint32_t GetNamespaceLimit(const string& ns, const ScopeType scope, uint32_t& size /* @out */) = 0;
        ...
        virtual uint32_t GetNamespaceSizes(const ScopeType scope, INamespaceSizeIterator*& namespaceSizes /* @out */) = 0;
    };
